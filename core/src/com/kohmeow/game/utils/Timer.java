...
public class Timer {
    ...
    public final static float GAMETIME  = 4800; // 1 real sec = 8 minte
    ...
    public Timer() {
        ...
        this.daysPassed = 0;
        this.paused = true;
        this.realToTimerRatio = Timer.GAMETIME;
        this.chrono = false;
    }
    ...
    public double getRemaining() {
        ...
        // this returns a negative number if timer is done, however could be modded to
        // return 0 instead.
    }
